...
<input type="text" class="form-control col-md-9 border-dark" id="add_surname">
 </div>
 <div class="form-group d-flex mt-3" >
 <label for="add_name" class="col-md-3 mt-2">Имя:</label>
<input type="text" class="form-control col-md-9 border-dark" id="add_name">
 </div>
 <div class="form-group d-flex mt-3" >
 <label for="add_middle_name" class="col-md-3 mt-2">Отчество:</label>
<input type="text" class="form-control col-md-9 border-dark" id="add_middle_name">
 </div>
 <div class="form-group d-flex mt-3" >
 <label for="add_middle_name" class="col-md-3 mt-2">Дата рождения:</label>
<input type="date" class="form-control col-md-5 border-dark" id="add_middle_name">
 </div>
...
<input type="text" class="form-control col-md-2 border-dark" id="add_nationality">
<label for="add_nationality" class="col-md-2 mt-2 offset-md-1">Номер:</label>
<input type="number" class="form-control col-md-3 border-dark" id="add_nationality">
 </div>
 <div class="input-group mb-3">
  <div class="custom-file">
    <input type="file" class="custom-file-input" id="add_photo">
    <label class="custom-file-label border-dark" for="add_photo">Фотогрфия...</label>
  </div>
</div>
<button type="submit" class="btn btn-outline-dark col-md-6 offset-md-3 mb-3">Добавить</button>
</form>
   </div>
   </div>
