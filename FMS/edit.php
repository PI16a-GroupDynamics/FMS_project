...
<input type="text" name="serial" required pattern="[0-9]{3} [0-9]{3}" required minlength="2" maxlength="4" value=<?php echo "'".$row[10]."'"; ?> class="form-control col-md-2 border-dark" id="add_nationality">
