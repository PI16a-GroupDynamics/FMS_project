...
<input type="text" name="serial" required pattern="[0-9]{2} [0-9]{2}" required minlength="5" maxlength="5" value=<?php echo "'".$row[10]."'"; ?> class="form-control col-md-2 border-dark" id="add_nationality">
